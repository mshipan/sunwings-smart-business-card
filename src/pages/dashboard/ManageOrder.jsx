...
import { useGetAllOrderQuery } from "../../redux/features/allApis/orderApi";
...
const ManageOrder = () => {
  ...
  const totalEntries = filteredOrders?.length || 0;
  ...
  return (
    <div className="h-screen my-10">
      <h1 className="text_db_36 mb-3">Manage Orders</h1>
      {/* orders table */}
      <div>
                ...
                <>
                  {currentEntries?.map((entry, i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-black">
                        {entry?.transactionId ? entry?.transactionId : "N/A"}
                      </td>
                    </tr>
                  ))}
                </>
          ...
          >
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400 block w-full md:inline md:w-auto">
              ...
              <span className="font-semibold text-gray-900 dark:text-black">
                {indexOfFirstEntry + 1}-
                {Math.min(indexOfLastEntry, allOrders?.length)}
              </span>{" "}
              of{" "}
              <span className="font-semibold text-gray-900 dark:text-black">
                {allOrders?.length}
